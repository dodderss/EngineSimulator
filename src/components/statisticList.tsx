...
function StatisticList() {
  ...
  return <div className="statList flex-col space-y-2 p-4 ">
    ...
    <StatisticItem image={PowerIcon.toString()} text={`${engine?.power || 0} HP`} />
    <StatisticItem image={TorqueIcon.toString()} text={`${engine?.torque || 0} Nm`} />
    <StatisticItem image={PriceIcon.toString()} text={`£${engine?.enginePrice || 0}`} />
    <StatisticItem image={EfficiencyIcon.toString()} text={`${engine?.totalEfficiency || 0}%`} />
    <StatisticItem image={WeightIcon.toString()} text={`${engine?.engineWeight || 0} KG`} />
